                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-md-6 ">
                            <a href="#" id="big-news">
                                <img src={require("../../../../public/images/image-tintuc/kybienban.jpg")} id="bigpic"></img>
                        ...
                        <div className="col-md-6 small-news">
                            <div className="sm-news">
                                <a href="#" id="sm-link">
                                <img src={require("../../../../public/images/image-tintuc/ngoaikhoa1.png")} id="smpic"></img>
                            ...
                            <div className="sm-news">
                                <a href="#" id="sm-link">
                                <img src={require("../../../../public/images/image-tintuc/ngoaikhoa2.jpg")} id="smpic"></img>
                            ...
                            <div className="sm-news">
                                <a href="#" id="sm-link">
                                <img src={require("../../../../public/images/image-tintuc/ngoaikhoa3.jpg")} id="smpic"></img>
